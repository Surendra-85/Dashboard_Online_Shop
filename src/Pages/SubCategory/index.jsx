...
const SubCategory = () => {
  ...
  return (
    ...
    <div className='cart bg-white shadow-md rounded-md p-5  flex items-center justify-between  '>
      <h1  className=' text-[20px] text-gray-800 font-bold'> Sub Category  List</h1>
       <div className='col w-[40%] ml-auto flex items-center gap-3'>
    <Button className='btn-blue !text-white !bg-green-600'>Export</Button>
    <Button className='btn-blue !text-white !bg-green-350 '><IoMdAdd className='text-white text-[20px]' />Add New Sub Catgory</Button>
...
<div className="relative overflow-x-auto !mt-5">
       ...
       <tbody>
        <tr className=' odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 dark:border-gray-700'>
            ...
            <Chip label="Fashion" onClick={handleClick} />
            </div>
            </td>
            <td className='px-6 py-2 !pr-0'>
           <div className="flex items-center justify-center">
           <div className='w-[60px]'>
            <Chip label="Men" onClick={handleClick}  color="primary"/>
            </div>
            <div className='w-[80px]'>
            <Chip label="Women" onClick={handleClick}   color="primary"/>
            </div>
            <div className='w-[60px]'>
            <Chip label="KInd" onClick={handleClick}  color="primary" />
            </div>
           </div>
            </td>
