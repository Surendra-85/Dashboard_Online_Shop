...
const HomeSliderBanner = () => {
  ...
  return (
    ...
    <div className='cart bg-white shadow-md rounded-md p-5  flex items-center justify-between  '>
      <h1  className=' text-[20px] text-gray-800 font-bold'>Home Slider Banner</h1>
       <div className='col w-[30%] ml-auto flex items-center gap-3'>
    <Button className='btn-blue !text-white !bg-green-600'>Export</Button>
    <Button className='btn-blue !text-white !bg-green-350 '><IoMdAdd className='text-white text-[20px]' />Add Home Slid</Button>
       ...
       <tbody>
        <tr className=' odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 dark:border-gray-700'>
            ...
            <div className="flex item-center gap-4 w-[300px] ">
                <div className="img w-[305px] h-[75px] rounded-md overflow-hidden group">
                <Link to="/product/355">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShU5RGj0QW-aK-Aqe-_BpNB8EiJw6pZkwgtw&s" alt="" className='w-full group-hover:scale-105 transition-all' />
        ...
        <tr className=' odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 dark:border-gray-700'>
            ...
            <div className="flex item-center gap-4 w-[300px] ">
                <div className="img w-[305px] h-[75px] rounded-md overflow-hidden group">
                <Link to="/product/355">
                    <img src="https://static.vecteezy.com/system/resources/thumbnails/002/006/774/small/paper-art-shopping-online-on-smartphone-and-new-buy-sale-promotion-backgroud-for-banner-market-ecommerce-free-vector.jpg" alt="" className='w-full group-hover:scale-105 transition-all' />
        ...
        <tr className=' odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 dark:border-gray-700'>
            ...
            <div className="flex item-center gap-4 w-[300px] ">
                <div className="img w-[305px] h-[75px] rounded-md overflow-hidden group">
                <Link to="/product/355">
                    <img src="https://t4.ftcdn.net/jpg/02/49/50/15/360_F_249501541_XmWdfAfUbWAvGxBwAM0ba2aYT36ntlpH.jpg" alt="" className='w-full group-hover:scale-105 transition-all' />
        ...
        <tr className='border-b odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 dark:border-gray-700'>
            ...
            <div className="flex item-center gap-4 w-[300px] ">
                <div className="img w-[305px] h-[75px] rounded-md overflow-hidden group">
                <Link to="/product/355">
                    <img src="https://static.vecteezy.com/system/resources/thumbnails/004/299/835/small/online-shopping-on-phone-buy-sell-business-digital-web-banner-application-money-advertising-payment-ecommerce-illustration-search-free-vector.jpg" alt="" className='w-full group-hover:scale-105 transition-all' />
